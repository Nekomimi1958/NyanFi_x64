	...
	TStringList *s_list)	//[o] 識別文字:コマンド名=説明
{
	c_list->Text =
		...
		"FV:ShowCR=テキストビューアで改行を表示/非表示\n"
		"FV:ShowLineNo=テキストビューアの行番号を表示/非表示\n"
		"FV:ShowRuby=テキストビューアでルビを表示/非表示\n"
		"FV:ShowRuler=テキストビューアのルーラを表示/非表示\n"
		"FV:ShowTAB=テキストビューアでタブを表示/非表示\n"

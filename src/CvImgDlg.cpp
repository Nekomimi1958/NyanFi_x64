...
void __fastcall TCvImageDlg::FormKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
	...
	if		(SameText(KeyStr, "Alt+B")) CvFmtRadioGroup->ItemIndex = 0;
	else if (SameText(KeyStr, "Alt+J")) CvFmtRadioGroup->ItemIndex = 1;
	else if (SameText(KeyStr, "Alt+P")) CvFmtRadioGroup->ItemIndex = 2;
	else if (SameText(KeyStr, "Alt+G")) CvFmtRadioGroup->ItemIndex = 3;
	else if (SameText(KeyStr, "Alt+T")) CvFmtRadioGroup->ItemIndex = 4;
	else if (SameText(KeyStr, "Alt+H")) CvFmtRadioGroup->ItemIndex = 5;
	else if (SameText(KeyStr, "Alt+S")) invert_CheckBox(GrayScaleCheckBox);
